...
public class HbarApproveTranslatorTest extends CallAttemptTestBase {
    @Mock
    ...
    void matchesHbarApprove() {
        ...
        // when
        attempt = createHasCallAttempt(
                TestHelpers.bytesForRedirectAccount(HBAR_APPROVE_PROXY.selector(), NON_SYSTEM_LONG_ZERO_ADDRESS),
                subject);
        assertThat(subject.identifyMethod(attempt)).isPresent();
    }
