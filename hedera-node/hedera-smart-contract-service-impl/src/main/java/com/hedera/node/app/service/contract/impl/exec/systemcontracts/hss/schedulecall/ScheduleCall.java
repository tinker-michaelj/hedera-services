 ...
 */
public class ScheduleCall extends AbstractCall {
    ...
    private final ContractID destContractID;
    ...
    public ScheduleCall(
            ...
            @NonNull final ContractID destContractID,
    ...
    public PricedResult execute(@NonNull final MessageFrame frame) {
        ...
        final var encodedRes = SCHEDULED_CALL.getOutputs().encode(Tuple.singleton(true));
    ...
    private @NonNull TransactionBody bodyForScheduleCreate(SchedulableTransactionBody scheduleTransactionBody) {
        return TransactionBody.newBuilder()
                ...
                .scheduleCreate(ScheduleCreateTransactionBody.newBuilder()
                        ...
                        .expirationTime(Timestamp.newBuilder().seconds(expiry).build())
                        .build())
                .build();
    }
    ...
    private SchedulableTransactionBody bodyForInnerScheduleCreate(MessageFrame frame) {
        return SchedulableTransactionBody.newBuilder()
                ...
                .contractCall(ContractCallTransactionBody.newBuilder()
                        ...
                        .functionParameters(com.hedera.pbj.runtime.io.buffer.Bytes.wrap(innerCallData.toArray())))
                .build();
    }
}
