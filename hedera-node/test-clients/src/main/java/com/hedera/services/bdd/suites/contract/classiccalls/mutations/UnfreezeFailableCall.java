...
public class UnfreezeFailableCall extends AbstractFailableNonStaticCall {
    private static final Function SIGNATURE = new Function("unfreezeToken(address,address)", "(int64)");

    public UnfreezeFailableCall() {
