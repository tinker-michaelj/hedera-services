...
public class FreezeFailableCall extends AbstractFailableNonStaticCall {
    private static final Function SIGNATURE = new Function("freezeToken(address,address)", "(int64)");

    public FreezeFailableCall() {
