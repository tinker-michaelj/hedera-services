...
public class IsApprovedForAllFailableCall extends AbstractFailableStaticCall {
    private static final Function SIGNATURE = new Function("isApprovedForAll(address,address,address)", "(int64,bool)");

    public IsApprovedForAllFailableCall() {
