...
public class DissociateTokensFailableCall extends AbstractFailableNonStaticCall {
    private static final Function SIGNATURE = new Function("dissociateTokens(address,address[])", "(int64)");

    public DissociateTokensFailableCall() {
        super(EnumSet.of(INVALID_TOKEN_ID_FAILURE, INVALID_ACCOUNT_ID_FAILURE));
    }

    @Override
    public String name() {
        return "dissociateTokens";
    }
