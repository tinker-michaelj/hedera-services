...
public class AssociateTokenFailableCall extends AbstractFailableNonStaticCall {
    private static final Function SIGNATURE = new Function("associateToken(address,address)", "(int64)");

    public AssociateTokenFailableCall() {
